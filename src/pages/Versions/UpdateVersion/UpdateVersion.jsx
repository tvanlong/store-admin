...
import { Breadcrumb, Button, Checkbox, Label, Select, TextInput, Textarea } from 'flowbite-react'
  ...
  return (
    <div className='mt-24 h-full'>
      ...
      <div className='mx-10 mt-20'>
        <Breadcrumb location='Cập nhật phiên bản sản phẩm' />
        <div className='flex justify-between'>
          <h2 className='mb-4 text-3xl font-extrabold text-gray-900'>Cập nhật phiên bản sản phẩm</h2>
          <button
