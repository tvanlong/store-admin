    ...
    <div className='flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center'>
      <div className='flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md'>
        <div className='p-4 py-6 text-white bg-black md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly'>
          ...
          <p className='mt-6 font-normal text-justify text-gray-300 md:mt-0'>
          ...
          <p className='mt-6 text-sm text-center text-gray-300'>&copy; 2021 All Rights Reserved.</p>
        </div>
        <div className='p-5 bg-white md:flex-1'>
          ...
          <form className='flex flex-col space-y-5' onSubmit={onSubmit}>
            ...
            <div>
              <button
                type='submit'
                className='w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-black rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4'
              >
                Đăng nhập
              </button>
            </div>
            <div className='flex flex-col space-y-5'>
              ...
              <div className='flex flex-col space-y-4'>
                ...
                <a className='flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-blue-500 rounded-md group hover:bg-blue-500 focus:outline-none'>
                  <span>
